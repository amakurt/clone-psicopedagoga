...
export default [
  ...
  { path: 'sala-espera', loadComponent: () => import('./pages/sala-espera.component').then(m => m.SalaEsperaComponent) },
  { path: 'tv', loadComponent: () => import('./pages/tv-sala-espera.component').then(m => m.TvSalaEsperaComponent) },
