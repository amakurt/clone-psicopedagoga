      ...
      <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        <div class="p-6">
          ...
          <div class="flex justify-end gap-2 mt-6 pt-4 border-t border-slate-200">
            ...
            <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary-dark transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
