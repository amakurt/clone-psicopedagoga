              ...
              <table class="w-full text-left border-collapse">
                <thead>
                  <tr class="bg-slate-50/50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800">
                    ...
                    <th class="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Pontuação</th>
                    <th class="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">Classificação</th>
