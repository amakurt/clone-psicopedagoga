            ...
            <div class="block md:hidden divide-y divide-slate-100 dark:divide-slate-800">
              @for (p of items(); track p.id) {
                <div class="p-4 space-y-3">
                  <div class="flex items-start justify-between gap-3">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div class="min-w-0 flex-1">
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400">{{ p.date | date:'dd/MM/yyyy' }}</p>
                      </div>
                    </div>
                  ...
                  <div class="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                    <span class="text-xs text-slate-500 font-bold">Pontuação Média:</span>
                    <div class="flex items-center gap-2">
                      ...
                      <span class="text-sm font-black text-slate-900 dark:text-white">{{ p.averageScore || 0 }}</span>
                    </div>
                  </div>

                  <div class="flex items-center gap-2 pt-1">
                    <a [routerLink]="['/app/protocolos', p.id]"
                    ...
                    <a [routerLink]="['/app/protocolos', p.id, 'editar']"
