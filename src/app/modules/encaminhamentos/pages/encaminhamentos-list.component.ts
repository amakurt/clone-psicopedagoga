...
@Component({
  ...
  template: `
    <div class="page">
      <div class="header">
        <div><h1>Encaminhamentos</h1><p class="subtitle">Encaminhamentos para atendimento</p></div>
        <a routerLink="/app/encaminhamentos/novo" class="btn btn-primary"><span class="material-icons" style="font-size:18px">add</span> Novo Encaminhamento</a>
      </div>
